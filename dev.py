...
# Version: 5.1.1 (Syntax Fixed + Production Ready)
...
try:
    ...
    try:
        ...
        # Fallback to built-in if pysqlite3 not available
        import sqlite3
...
# FIX: bot is defined later, so we use a global reference
_bot_instance = None
...
_bot_instance = bot  # Set global reference
...
# ─── Helper to get chat_id from event ──────────────────────────────────────
...
# ─── Helper to check if event is from private chat ────────────────────────
